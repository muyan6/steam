...
fn get_authoritative_rule(app_id: u32) -> Option<(String, Vec<String>)> {
    ...
    let fallback = match app_id {
        ...
        250900 => Some(("steamworks", vec!["以撒的结合·官方联机/同屏", "Steamworks"])),
        1281930 => Some(("steamworks", vec!["tModLoader·泰拉瑞亚Mod联机", "Steamworks"])),
        ...
        632810 => Some(("tool", vec!["Soundpad Demo·语音音效实用软件"])),
