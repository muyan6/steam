  ...
  <div class="h-full flex flex-col p-6 overflow-hidden">
    ...
    <div class="flex items-center justify-between mb-5 flex-wrap gap-3 shrink-0">
      ...
      <div class="flex items-center gap-2.5">
        ...
        <button
          @click="loadLibrary"
          class="px-3.5 py-2 bg-slate-800/80 hover:bg-slate-700 border border-slate-700/60 rounded-xl text-xs font-medium text-slate-200 transition flex items-center gap-1.5"
        >
    ...
    <div v-if="unlockedGames.length > 0" class="mb-4 flex items-center gap-3 shrink-0">
      <div class="relative flex-1 max-w-sm">
        <input
          ...
          class="w-full bg-slate-900/80 border border-slate-700/60 rounded-xl px-3.5 py-2 pl-9 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-400/30 transition shadow-inner"
        />
        ...
        >
          ...
          <div class="flex items-center gap-3 min-w-0">
            <img
              ...
              class="w-20 h-10 object-cover rounded-lg bg-slate-900 shadow shrink-0 border border-white/5"
              loading="lazy"
            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="flex items-center gap-1.5 mt-1.5 flex-wrap">
                ...
                <span
                  ...
                  class="text-[10px] px-1.5 py-0.2 rounded bg-emerald-500/20 text-emerald-300 font-mono flex items-center gap-1"
                ...
                <span
                  v-if="game.hasToken"
                  class="text-[10px] px-1.5 py-0.2 rounded bg-purple-500/20 text-purple-300 font-mono flex items-center gap-1"
                ...
                <span
                  v-else
                  class="text-[10px] px-1.5 py-0.2 rounded bg-sky-500/20 text-sky-300 font-mono flex items-center gap-1"
          ...
          <div class="flex items-center justify-between gap-2 pt-2.5 border-t border-slate-800/80">
            <div class="flex items-center gap-1.5 flex-wrap">
              ...
              <a
                ...
                class="px-2.5 py-1.5 bg-emerald-600/20 hover:bg-emerald-600/40 border border-emerald-500/30 text-emerald-300 text-xs font-semibold rounded-lg transition flex items-center gap-1"
              >
                <Play class="w-3 h-3 fill-emerald-300" />
                <span>运行</span>
              </a>
            ...
            <button
              ...
              class="px-2.5 py-1.5 bg-rose-600/20 hover:bg-rose-600/40 border border-rose-500/30 text-rose-300 text-xs font-medium rounded-lg transition flex items-center gap-1"
            >
